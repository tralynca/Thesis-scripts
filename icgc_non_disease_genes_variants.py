...
path_bed = '/home/tracey/Desktop/MASTERS_2014/ICGC/bed_files_non_disease_175_random_genes/UNIQ_bed_range/introns_93_non_disease_genes_UNIQ.txt'
...
#--------------------------------------------------------------------------------------- 
sys.stdout = open ('/home/tracey/Desktop/MASTERS_2014/ICGC/SV_results/Non_disease_genes_hits/Results/non_cod_introns_icgc.txt', 'w')
for icgc in icgc_list:
    for bed in bed_list:
        if icgc[0] == bed[0] and icgc[1] >= bed[1] and icgc[2] <= bed[2] and bed[3] == '+':
            print icgc[0] + '\t' + str(icgc[1]) + '\t' + str(icgc[2]) + '\t' + icgc[3] + '\t' + icgc[4] + '\t' + icgc[5] + '\t' + icgc[6] + '\t' + icgc[7] + '\t' + icgc[8] + '\t' + icgc[9] + '\t' + icgc[10] + '\t' + icgc[11] + '\t' + icgc[12] + '\t' + icgc[13] + '\t' + 'introns' + '\t' + icgc[14] + '\t' + bed[3] 
